...
test_Main.addTests = function(runner) {
	runner.addCase(new test_vmort_utils_ExtensionsTest());
	runner.addCase(new test_vmort_ValOrFuncTest());
};
test_Main.main = function() {
	var runner = new utest_Runner();
	test_Main.addTests(runner);
	utest_ui_Report.create(runner);
	runner.run();
};
var test_vmort_ValOrFuncTest = function() {
};
test_vmort_ValOrFuncTest.__name__ = ["test","vmort","ValOrFuncTest"];
...
var test_vmort_utils_ExtensionsTest = function() {
};
test_vmort_utils_ExtensionsTest.__name__ = ["test","vmort","utils","ExtensionsTest"];
test_vmort_utils_ExtensionsTest.prototype = {
	testEquals: function() {
		utest_Assert.isTrue(vmort_utils_Extensions.equals(1,1),null,{ fileName : "ExtensionsTest.hx", lineNumber : 11, className : "test.vmort.utils.ExtensionsTest", methodName : "testEquals"});
		utest_Assert.isTrue(vmort_utils_Extensions.equals("test","test"),null,{ fileName : "ExtensionsTest.hx", lineNumber : 12, className : "test.vmort.utils.ExtensionsTest", methodName : "testEquals"});
		utest_Assert.isFalse(vmort_utils_Extensions.equals(1,2),null,{ fileName : "ExtensionsTest.hx", lineNumber : 13, className : "test.vmort.utils.ExtensionsTest", methodName : "testEquals"});
		utest_Assert.isFalse(vmort_utils_Extensions.equals("test","hi"),null,{ fileName : "ExtensionsTest.hx", lineNumber : 14, className : "test.vmort.utils.ExtensionsTest", methodName : "testEquals"});
	}
	,testContains: function() {
		utest_Assert.isTrue(vmort_utils_Extensions.contains([1,2,3],1),null,{ fileName : "ExtensionsTest.hx", lineNumber : 18, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isTrue(vmort_utils_Extensions.contains([2,3,1],2),null,{ fileName : "ExtensionsTest.hx", lineNumber : 19, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isTrue(vmort_utils_Extensions.contains(["one","three","two"],"three"),null,{ fileName : "ExtensionsTest.hx", lineNumber : 20, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isFalse(vmort_utils_Extensions.contains([],1),null,{ fileName : "ExtensionsTest.hx", lineNumber : 22, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isFalse(vmort_utils_Extensions.contains([],null),null,{ fileName : "ExtensionsTest.hx", lineNumber : 23, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isFalse(vmort_utils_Extensions.contains([1,2,3],4),null,{ fileName : "ExtensionsTest.hx", lineNumber : 24, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isFalse(vmort_utils_Extensions.contains(["one","three","two"],"four"),null,{ fileName : "ExtensionsTest.hx", lineNumber : 25, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isFalse(vmort_utils_Extensions.contains(["one","three","two"],"twox"),null,{ fileName : "ExtensionsTest.hx", lineNumber : 26, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isTrue(vmort_utils_Extensions.contains([{ key : "one"},{ key : "two"}],{ key : "two"},function(a,b) {
			return a.key == b.key;
		}),null,{ fileName : "ExtensionsTest.hx", lineNumber : 28, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isFalse(vmort_utils_Extensions.contains([{ key : "one"},{ key : "two"}],{ key : "three"},function(a1,b1) {
			return a1.key == b1.key;
		}),null,{ fileName : "ExtensionsTest.hx", lineNumber : 32, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
	}
	,testUnique: function() {
		utest_Assert.same([1,2,3],vmort_utils_Extensions.unique([1,1,2,3,3,3]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 38, className : "test.vmort.utils.ExtensionsTest", methodName : "testUnique"});
		utest_Assert.same([2,3,1],vmort_utils_Extensions.unique([2,2,2,3,3,1,1]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 39, className : "test.vmort.utils.ExtensionsTest", methodName : "testUnique"});
		utest_Assert.same(["one","two","three"],vmort_utils_Extensions.unique(["one","one","two","two","three"]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 40, className : "test.vmort.utils.ExtensionsTest", methodName : "testUnique"});
		utest_Assert.same(["two","three","one"],vmort_utils_Extensions.unique(["two","two","three","one","one"]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 41, className : "test.vmort.utils.ExtensionsTest", methodName : "testUnique"});
		utest_Assert.same([{ key : "one"},{ key : "two"}],vmort_utils_Extensions.unique([{ key : "one"},{ key : "one"},{ key : "two"},{ key : "two"}],function(a,b) {
			return a.key == b.key;
		}),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 43, className : "test.vmort.utils.ExtensionsTest", methodName : "testUnique"});
	}
	,testIntersection: function() {
		utest_Assert.same([2,3],vmort_utils_Extensions.intersection([1,2,3],[2,3,4]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 49, className : "test.vmort.utils.ExtensionsTest", methodName : "testIntersection"});
		utest_Assert.same([1,2,3,4],vmort_utils_Extensions.intersection([1,2,3,4,5,6],[4,3,2,1]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 50, className : "test.vmort.utils.ExtensionsTest", methodName : "testIntersection"});
	}
	,testDifference: function() {
		utest_Assert.same([1,4],vmort_utils_Extensions.difference([1,2,3,4],[2,3]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 54, className : "test.vmort.utils.ExtensionsTest", methodName : "testDifference"});
		utest_Assert.same([4,1],vmort_utils_Extensions.difference([4,3,2,1],[2,3]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 55, className : "test.vmort.utils.ExtensionsTest", methodName : "testDifference"});
	}
	,testDiff: function() {
		utest_Assert.same({ left : [1,2], both : [3,4], right : [5,6]},vmort_utils_Extensions.diff([1,2,3,4],[3,4,5,6]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 59, className : "test.vmort.utils.ExtensionsTest", methodName : "testDiff"});
		utest_Assert.same({ left : ["one","two"], both : ["three","four"], right : ["five","six"]},vmort_utils_Extensions.diff(["one","two","three","four"],["three","four","five","six"]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 60, className : "test.vmort.utils.ExtensionsTest", methodName : "testDiff"});
		var left = [{ key : "one"},{ key : "two"},{ key : "three"},{ key : "four"}];
		var right = [{ key : "three"},{ key : "four"},{ key : "five"},{ key : "six"}];
		var expected = { left : [{ key : "one"},{ key : "two"}], both : [{ key : "three"},{ key : "four"}], right : [{ key : "five"},{ key : "six"}]};
		var predicate = function(a,b) {
			return a.key == b.key;
		};
		utest_Assert.same(expected,vmort_utils_Extensions.diff(left,right,predicate),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 96, className : "test.vmort.utils.ExtensionsTest", methodName : "testDiff"});
	}
	,__class__: test_vmort_utils_ExtensionsTest
};
...
var vmort_utils_Extensions = function() { };
vmort_utils_Extensions.__name__ = ["vmort","utils","Extensions"];
vmort_utils_Extensions.equals = function(a,b) {
	return a == b;
};
vmort_utils_Extensions.contains = function(array,value,predicate) {
	if(predicate == null) predicate = vmort_utils_Extensions.equals;
	return Lambda.find(array,function(a) {
		return predicate(a,value);
	}) != null;
};
vmort_utils_Extensions.unique = function(array,predicate) {
	return Lambda.fold(array,function(a,acc) {
		if(!vmort_utils_Extensions.contains(acc,a,predicate)) acc.push(a);
		return acc;
	},[]);
};
vmort_utils_Extensions.intersection = function(left,right,predicate) {
	var uleft = vmort_utils_Extensions.unique(left,predicate);
	var uright = vmort_utils_Extensions.unique(right,predicate);
	return Lambda.fold(uleft,function(l,acc) {
		if(vmort_utils_Extensions.contains(uright,l,predicate)) acc.push(l);
		return acc;
	},[]);
};
vmort_utils_Extensions.difference = function(left,right,predicate) {
	var uleft = vmort_utils_Extensions.unique(left,predicate);
	var uright = vmort_utils_Extensions.unique(right,predicate);
	return Lambda.fold(uleft,function(l,acc) {
		if(!vmort_utils_Extensions.contains(uright,l,predicate)) acc.push(l);
...
vmort_utils_Extensions.diff = function(left,right,predicate) {
	return { left : vmort_utils_Extensions.difference(left,right,predicate), both : vmort_utils_Extensions.intersection(left,right,predicate), right : vmort_utils_Extensions.difference(right,left,predicate)};
};
