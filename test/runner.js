...
test_vmort_utils_ExtensionsTest.prototype = {
	testEquals: function() {
		utest_Assert.isTrue(vmort_util_Objects.equals(1,1),null,{ fileName : "ExtensionsTest.hx", lineNumber : 13, className : "test.vmort.utils.ExtensionsTest", methodName : "testEquals"});
		utest_Assert.isTrue(vmort_util_Objects.equals("test","test"),null,{ fileName : "ExtensionsTest.hx", lineNumber : 14, className : "test.vmort.utils.ExtensionsTest", methodName : "testEquals"});
		utest_Assert.isFalse(vmort_util_Objects.equals(1,2),null,{ fileName : "ExtensionsTest.hx", lineNumber : 15, className : "test.vmort.utils.ExtensionsTest", methodName : "testEquals"});
		utest_Assert.isFalse(vmort_util_Objects.equals("test","hi"),null,{ fileName : "ExtensionsTest.hx", lineNumber : 16, className : "test.vmort.utils.ExtensionsTest", methodName : "testEquals"});
	}
	,testContains: function() {
		utest_Assert.isTrue(vmort_util_Arrays.contains([1,2,3],1),null,{ fileName : "ExtensionsTest.hx", lineNumber : 20, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isTrue(vmort_util_Arrays.contains([2,3,1],2),null,{ fileName : "ExtensionsTest.hx", lineNumber : 21, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isTrue(vmort_util_Arrays.contains(["one","three","two"],"three"),null,{ fileName : "ExtensionsTest.hx", lineNumber : 22, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isFalse(vmort_util_Arrays.contains([],1),null,{ fileName : "ExtensionsTest.hx", lineNumber : 24, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isFalse(vmort_util_Arrays.contains([],null),null,{ fileName : "ExtensionsTest.hx", lineNumber : 25, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isFalse(vmort_util_Arrays.contains([1,2,3],4),null,{ fileName : "ExtensionsTest.hx", lineNumber : 26, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isFalse(vmort_util_Arrays.contains(["one","three","two"],"four"),null,{ fileName : "ExtensionsTest.hx", lineNumber : 27, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isFalse(vmort_util_Arrays.contains(["one","three","two"],"twox"),null,{ fileName : "ExtensionsTest.hx", lineNumber : 28, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isTrue(vmort_util_Arrays.contains([{ key : "one"},{ key : "two"}],{ key : "two"},function(a,b) {
			return a.key == b.key;
		}),null,{ fileName : "ExtensionsTest.hx", lineNumber : 30, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
		utest_Assert.isFalse(vmort_util_Arrays.contains([{ key : "one"},{ key : "two"}],{ key : "three"},function(a1,b1) {
			return a1.key == b1.key;
		}),null,{ fileName : "ExtensionsTest.hx", lineNumber : 34, className : "test.vmort.utils.ExtensionsTest", methodName : "testContains"});
	}
	,testUnique: function() {
		utest_Assert.same([1,2,3],vmort_util_Arrays.unique([1,1,2,3,3,3]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 40, className : "test.vmort.utils.ExtensionsTest", methodName : "testUnique"});
		utest_Assert.same([2,3,1],vmort_util_Arrays.unique([2,2,2,3,3,1,1]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 41, className : "test.vmort.utils.ExtensionsTest", methodName : "testUnique"});
		utest_Assert.same(["one","two","three"],vmort_util_Arrays.unique(["one","one","two","two","three"]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 42, className : "test.vmort.utils.ExtensionsTest", methodName : "testUnique"});
		utest_Assert.same(["two","three","one"],vmort_util_Arrays.unique(["two","two","three","one","one"]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 43, className : "test.vmort.utils.ExtensionsTest", methodName : "testUnique"});
		utest_Assert.same([{ key : "one"},{ key : "two"}],vmort_util_Arrays.unique([{ key : "one"},{ key : "one"},{ key : "two"},{ key : "two"}],function(a,b) {
			return a.key == b.key;
		}),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 45, className : "test.vmort.utils.ExtensionsTest", methodName : "testUnique"});
	}
	,testIntersection: function() {
		utest_Assert.same([2,3],vmort_util_Arrays.intersection([1,2,3],[2,3,4]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 51, className : "test.vmort.utils.ExtensionsTest", methodName : "testIntersection"});
		utest_Assert.same([1,2,3,4],vmort_util_Arrays.intersection([1,2,3,4,5,6],[4,3,2,1]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 52, className : "test.vmort.utils.ExtensionsTest", methodName : "testIntersection"});
	}
	,testDifference: function() {
		utest_Assert.same([1,4],vmort_util_Arrays.difference([1,2,3,4],[2,3]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 56, className : "test.vmort.utils.ExtensionsTest", methodName : "testDifference"});
		utest_Assert.same([4,1],vmort_util_Arrays.difference([4,3,2,1],[2,3]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 57, className : "test.vmort.utils.ExtensionsTest", methodName : "testDifference"});
	}
	,testDiff: function() {
		utest_Assert.same({ left : [1,2], both : [3,4], right : [5,6]},vmort_util_Arrays.diff([1,2,3,4],[3,4,5,6]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 61, className : "test.vmort.utils.ExtensionsTest", methodName : "testDiff"});
		utest_Assert.same({ left : ["one","two"], both : ["three","four"], right : ["five","six"]},vmort_util_Arrays.diff(["one","two","three","four"],["three","four","five","six"]),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 62, className : "test.vmort.utils.ExtensionsTest", methodName : "testDiff"});
		...
		utest_Assert.same(expected,vmort_util_Arrays.diff(left,right,predicate),null,null,{ fileName : "ExtensionsTest.hx", lineNumber : 98, className : "test.vmort.utils.ExtensionsTest", methodName : "testDiff"});
	}
...
vmort_util_Arrays.__name__ = ["vmort","util","Arrays"];
...
vmort_util_Iterators.__name__ = ["vmort","util","Iterators"];
...
vmort_util_Objects.__name__ = ["vmort","util","Objects"];
